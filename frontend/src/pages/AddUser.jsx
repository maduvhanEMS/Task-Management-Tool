...
import { addUser, reset, resetAdded } from '../features/auth/authSlice';
...
function AddUser() {
  ...
  const { isError, isSuccess, isLoading, message, added } = useSelector(
    (state) => state.auth
  );
  ...
  useEffect(() => {
    ...
    dispatch(reset());
    dispatch(resetAdded());
  }, [isError, added, message, dispatch, navigate]);
